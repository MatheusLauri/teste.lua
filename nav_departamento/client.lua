...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	elseif data == "utilidades-comprar-ziplock" then
		TriggerServerEvent("departamento-comprar","ziplock")
	elseif data == "utilidades-comprar-glicerina" then
		TriggerServerEvent("departamento-comprar","glicerina")
	elseif data == "utilidades-comprar-pipe" then
		TriggerServerEvent("departamento-comprar","pipe")
	...
	elseif data == "utilidades-vender-ferramenta" then
	...
	elseif data == "utilidades-vender-ziplock" then
		TriggerServerEvent("departamento-vender","ziplock")
	elseif data == "utilidades-vender-glicerina" then
		TriggerServerEvent("departamento-vender","glicerina")
	elseif data == "utilidades-vender-pipe" then
		TriggerServerEvent("departamento-vender","pipe")
