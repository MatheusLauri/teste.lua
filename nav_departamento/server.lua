...
-----------------------------------------------------------------------------------------------------------------------------------------
local valores = {
	{ item = "isca", quantidade = 10, compra = 200, venda = 100 },
	...
	{ item = "seda", quantidade = 10, compra = 100, venda = 50 },
	{ item = "ziplock", quantidade = 10, compra = 100, venda = 50 },
	{ item = "glicerina", quantidade = 10, compra = 100, venda = 50 },
	{ item = "pipe", quantidade = 10, compra = 100, venda = 50 },

	{ item = "mochila", quantidade = 1, compra = 6000, venda = 3000 },
	{ item = "roupas", quantidade = 1, compra = 4000, venda = 2000 },
